...
function interpretarExcel(archivo){
    ...
    reader.onload = function(e) {
        ...
        workbook.SheetNames.forEach(function(sheetName, index) {
            ...
            if(sheetName !== 'Codigos' && sheetName !== 'Facturacion'){  
                ...
                for(let i = 0; i < jsonData.length; i++){
                    if(jsonData[i][0]){
                        ...
                        } else if (jsonData[i][0].endsWith(':')) {
                            const contenidoH3 = document.createElement('h3');
                            contenidoH3.textContent = jsonData[i][0];
                            celdaContenido.appendChild(contenidoH3);
                        } else if (jsonData[i][0].endsWith('cluye:')) {
            ...
            else if(sheetName === 'Codigos'){
                if(jsonData[0][1] == 'PRACTICA OSDE'){
                    const contenidoH3 = document.createElement('h3');
                    contenidoH3.textContent = 'PRACTICA OSDE';
                    contenidoH3.classList.add('titulo-codigo');
                    celdaContenido.appendChild(contenidoH3);
                }
